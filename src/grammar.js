...
const lexer = moo.compile({
  ...
  hat0arg: ['event_whenflagclicked', 'event_whenthisspriteclicked'],
...
var grammar = {
    ...
    {"name": "callable", "symbols": [(lexer.has("op1arg") ? {type: "op1arg"} : op1arg), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "reportable", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": genOpcode()},
    ...
    {"name": "syntax", "symbols": [(lexer.has("atmark") ? {type: "atmark"} : atmark), (lexer.has("hat1arg") ? {type: "hat1arg"} : hat1arg), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "menuitem", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": genOpcodeForHats()},
    ...
    {"name": "boolable", "symbols": ["_"], "postprocess": skip},
