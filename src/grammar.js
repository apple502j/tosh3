...
var grammar = {
    ...
    {"name": "script", "symbols": ["line"], "postprocess": ([scr]) => [scr]},
    ...
    {"name": "syntax", "symbols": [(lexer.has("atmark") ? {type: "atmark"} : atmark), (lexer.has("hat0arg") ? {type: "hat0arg"} : hat0arg), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": genOpcodeForHats()},
    {"name": "syntax", "symbols": [(lexer.has("atmark") ? {type: "atmark"} : atmark), (lexer.has("hatM") ? {type: "hatM"} : hatM), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "menuitem", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": genOpcodeForHats()},
    {"name": "syntax", "symbols": [(lexer.has("atmark") ? {type: "atmark"} : atmark), (lexer.has("hatMN") ? {type: "hatMN"} : hatMN), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "menuitem", "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "numable", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": genOpcodeForHats()},
    {"name": "syntax", "symbols": ["define"], "postprocess": id},
    {"name": "syntax", "symbols": [(lexer.has("foreversyntax") ? {type: "foreversyntax"} : foreversyntax), "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "script", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": genOpcode("control_forever")},
    {"name": "syntax", "symbols": [(lexer.has("ifsyntax") ? {type: "ifsyntax"} : ifsyntax), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "boolable", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen), "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "script", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket), "_", (lexer.has("elsesyntax") ? {type: "elsesyntax"} : elsesyntax), "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "script", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": genOpcode("control_ifelse")},
    {"name": "syntax", "symbols": [(lexer.has("untilsyntax") ? {type: "untilsyntax"} : untilsyntax), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "boolable", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen), "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "script", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": genOpcode("control_repeat_until")},
    {"name": "syntax", "symbols": [(lexer.has("repeatsyntax") ? {type: "repeatsyntax"} : repeatsyntax), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "numable", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen), "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "script", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": genOpcode("control_repeat")},
    ...
    {"name": "procedure", "symbols": [(lexer.has("procedurecallsyntax") ? {type: "procedurecallsyntax"} : procedurecallsyntax), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", (lexer.has("string") ? {type: "string"} : string), "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "procargs", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": d => procedureCall(d)},
